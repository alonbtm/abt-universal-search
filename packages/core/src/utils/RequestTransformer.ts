...
export class RequestTransformer {
  ...
  public transformRequest(
    ...
    if (config.requestTransform?.dynamicHeaders) {
      Object.assign(headers, this.generateDynamicHeaders(
        config.requestTransform.dynamicHeaders, 
        query
      ));
    }
  ...
  private transformPostRequest(
    ...
    if (config.requestTransform?.graphql) {
      ...
      if (config.requestTransform?.additionalParams) {
        Object.assign(body as Record<string, unknown>, config.requestTransform.additionalParams);
      }
   ...
   */
  private transformQueryValue(query: string, transformConfig?: RequestTransformConfig): string {
  ...
  private generateDynamicHeaders(
    dynamicHeadersConfig: Record<string, string>,
    query: ProcessedQuery
  ...
  private buildGraphQLRequest(
    query: string,
    graphqlConfig: NonNullable<RequestTransformConfig['graphql']>,
   ...
   */
  public validateTransformConfig(config: RequestTransformConfig): void {
   ...
   */
  public extractSearchParams(url: string): Record<string, string> {
    try {
   ...
   */
  public parseRequestBody(body: string | unknown): Record<string, unknown> {
   ...
   */
  public buildUrlWithParams(baseUrl: string, params: Record<string, string | number | boolean>): string {
