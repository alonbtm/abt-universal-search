 ...
 */
export function validateTargetElement(element: Element | null, selector: string): asserts element is HTMLElement {
  if (!element) {
 ...
 */
export function validateConfiguration(config: Partial<SearchConfiguration>): void {
 ...
 */
export function isValidQuery(query: string, minLength: number): boolean {
