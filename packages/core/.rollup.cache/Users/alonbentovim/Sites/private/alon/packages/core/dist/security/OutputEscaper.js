 ...
 */
export const DEFAULT_HTML_ESCAPING_CONFIG = {
...
export class OutputEscaper {
     ...
     */
    escapeHTML(content, customConfig) {
     ...
     */
    removeZeroWidthCharacters(content) {
        let result = content;
 ...
 */
export function escapeHTML(content, config) {
    return defaultOutputEscaper.escapeHTML(content, config).escaped;
}
/**
 * Convenience function for safe DOM insertion
 */
export function safeInsert(targetElement, content, method = 'textContent') {
...
//# sourceMappingURL=OutputEscaper.js.map