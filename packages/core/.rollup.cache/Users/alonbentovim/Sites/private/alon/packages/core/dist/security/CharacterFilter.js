...
export class CharacterFilter {
    constructor(config, normalizationForm = 'NFC') {
        this.config = config || {
     ...
     */
    escapeCharacters(input, charactersToEscape) {
        const escapeMap = {
            '<': '&lt;',
            '>': '&gt;',
            '"': '&quot;',
     ...
     */
    filterInternationalCharacters(input) {
        const warnings = [];
        // ASCII range: 0-127
     ...
     */
    detectDangerousCharacters(input) {
        const warnings = [];
...
//# sourceMappingURL=CharacterFilter.js.map