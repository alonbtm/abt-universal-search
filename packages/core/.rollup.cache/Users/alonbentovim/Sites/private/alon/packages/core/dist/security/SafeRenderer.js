 ...
 */
export const DEFAULT_SAFE_TEMPLATE_CONFIG = {
...
export class SafeRenderer {
     ...
     */
    renderTemplate(template, context, customConfig) {
     ...
     */
    renderBuiltIn(templateName, context, config) {
     ...
     */
    compileTemplate(template, config) {
     ...
     */
    executeTemplate(compiled, context, config) {
        let result = '';
     ...
     */
    valueToString(value, sanitizationLevel) {
     ...
     */
    calculateTemplateDepth(template) {
        let depth = 0;
        let maxDepth = 0;
 ...
 */
export function renderTemplate(template, variables, config) {
    const context = {
        variables,
        timestamp: Date.now(),
        securityContext: {
 ...
 */
export function renderBuiltIn(templateName, variables) {
    const context = {
        variables,
        timestamp: Date.now(),
        securityContext: {
...
//# sourceMappingURL=SafeRenderer.js.map