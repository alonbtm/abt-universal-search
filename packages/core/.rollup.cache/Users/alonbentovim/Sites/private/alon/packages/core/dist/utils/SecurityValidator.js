...
export class SecurityValidator {
     ...
     */
    validateSQL(sql, parameters = [], config) {
        const errors = [];
        const warnings = [];
        let riskLevel = 'low';
     ...
     */
    validateConnectionString(connectionString, databaseType) {
        const errors = [];
     ...
     */
    validateQueryParameters(parameters, expectedTypes) {
        const errors = [];
        const sanitized = [];
     ...
     * Check for SQL injection patterns
     */
    checkSQLInjection(sql, parameters) {
        const errors = [];
     ...
     * Check query complexity
     */
    checkQueryComplexity(sql, config) {
        const warnings = [];
        // Count JOINs
     ...
     */
    containsMaliciousContent(param) {
     ...
     */
    matchesExpectedType(param, expectedType) {
...
SecurityValidatorFactory.validators = new Map();
/**
